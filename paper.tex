...
\Title{梯度流图像生成对抗网络的性能研究
} %题目
\SubjectMajor{计算机科学与技术}                  %学科专业
\Grade{2020级}               %年级
\StudentID{202010100079}     %学号
\Graduate{万畅}             %作者
\Advisor{李明禄、郑忠龙}     
% \Graduate{***}             %作者
% \Advisor{***}   
...
% === 中英文扉面内容 ===%
\Title{梯度流图像生成对抗网络的性能研究} %
\EnglishTitle{\textsc{Performance study of gradient-flow-based GAN for image generation}}
% \upperTitle{Gradient Flow Based Generative Models Research}
% \Author{***}                               %作者
% \EnglishAuthor{***}   
\Author{万畅}                               %作者
\EnglishAuthor{Chang Wan}                  %英文作者
% \Advisor{李明禄，郑忠龙}                              %导师
\EnglishAdvisor{Minglu Li, Zhonglong Zheng}     %英文导师
% \Advisor{***}                              %导师
% \EnglishAdvisor{***}    
\Major{计算机科学与技术}                              %专业
